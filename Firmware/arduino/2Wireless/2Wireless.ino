...
String customPageString = "<html><head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"></head> <body> <label style=\"font-size:16px;\">Use WriteCustomPage.html to load custom page here.</label></body></html>";
...
void setup() {
  ...
  //If custom page has been defined using USERPAGE_START_POINTER and USERPAGE_LENGTH_ADDRESS
  //then read html from FRAM into customPageString.
  //getCustomPage();
